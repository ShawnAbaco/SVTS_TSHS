...
<div class="main-container">
    ...
    <!-- Anecdotal Container -->
    <form id="anecdotalForm" method="POST" action="{{ route('adviser.violation-anecdotal.store') }}">
        @csrf
...
<script>
    ...
    const violationSearchUrl = "{{ route('adviser.violation-anecdotal.search-violations') }}";
