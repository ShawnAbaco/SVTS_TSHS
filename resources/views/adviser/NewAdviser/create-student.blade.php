...
<style>
    ...
    <div class="main-container">
        ...
        <form id="studentForm" method="POST" action="{{ route('adviser.students.store') }}">
            @csrf
            <!-- Hidden adviser_id field at form level (for the entire form) -->
    ...
    <script>
        ...
        const studentManagementUrl = "{{ route('adviser.student.management') }}";
        ...
        function addStudentForm() {
            ...
            <div class="form-grid">
                ...
                <!-- HIDDEN ADVISER FIELD - Auto-filled with logged-in adviser -->
            ...
            // Attach search functionality to the new form (only for parent search)
        ...
        function attachSearchListeners(container, studentIndex) {
            ...
            // Parent search functionality only
            ...
            document.addEventListener('click', function(e) {
                // Check if click is outside parent search inputs and results
        ...
        document.getElementById('btnSave').addEventListener('click', function() {
            ...
            studentContainers.forEach((container, index) => {
                ...
                // Reset borders
                [firstName, lastName, birthdate, address, contactInfo, parentId].forEach(
                field => {
                    if (field) field.style.borderColor = '#ddd';
                });
                if (parentSearch) parentSearch.style.borderColor = '#ddd';

                // Check required fields (no need to check adviser_id as it's auto-filled)
                if (!firstName.value || !lastName.value || !birthdate.value || !address.value || !
                    contactInfo.value || !parentId.value) {
                    isValid = false;
