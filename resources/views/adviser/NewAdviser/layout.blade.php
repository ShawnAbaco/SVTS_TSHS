...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/adviser/edit.css') }}">
    <link rel="stylesheet" href="{{ asset('css/adviser/info.css') }}">
    <link rel="stylesheet" href="{{ asset('css/adviser/layouts-sidebar.css') }}">
    <link rel="stylesheet" href="{{ asset('css/adviser/main-container.css') }}">
    <link rel="stylesheet" href="{{ asset('css/adviser/modal.css') }}">
    <link rel="stylesheet" href="{{ asset('css/adviser/offenses-sanction.css') }}">
    <link rel="stylesheet" href="{{ asset('css/adviser/settlement-modal.css') }}">
    <link rel="stylesheet" href="{{ asset('css/adviser/reports.css') }}">
    <link rel="stylesheet" href="{{ asset('css/adviser/table-container.css') }}">
    <link rel="stylesheet" href="{{ asset('css/adviser/closebuttonall.css') }}">
    <link rel="stylesheet" href="{{ asset('css/adviser/pdfandexcel.css') }}">
</head>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <!-- Main navigation -->
        <nav aria-label="Adviser navigation">
            <ul>
                ...
                <li class="{{ request()->routeIs('adviser.parent.lists') ? 'active' : '' }}">
                    <a href="{{ route('adviser.parent.lists') }}">
                        <i class="fas fa-user-friends"></i>
                        <span>Parents</span>
                    </a>
                </li>

                <li class="{{ request()->routeIs('adviser.student.management') ? 'active' : '' }}">
                    <a href="{{ route('adviser.student.management') }}">
                ...
                <li class="{{ request()->routeIs('adviser.violationAnecdotal') ? 'active' : '' }}">
                ...
                <li class="{{ request()->routeIs('adviser.violationAppointment') ? 'active' : '' }}">
                ...
                <li class="{{ request()->routeIs('offenses.sanctions') ? 'active' : '' }}">
                    <a href="{{ route('adviser.offenses.sanctions') }}">
                        <i class="fas fa-exclamation-triangle"></i>
                        <span>Offenses Types</span>
                    </a>
                </li>
            </ul>
        </nav>
                            ...
                            <div class="profile-header">
                                <div class="avatar-container">
                                    <div class="avatar-wrapper">
                                        <!-- CHANGED: Use asset() instead of Storage::url() -->
                                        <img id="profile-image-preview"
                                            src="{{ Auth::guard('adviser')->user()->profile_image ? asset('storage/' . Auth::guard('adviser')->user()->profile_image) : asset('images/user.jpg') }}"
                                ...
                                <div class="profile-meta">
                                    <h4 id="profile-name">
                                        {{ Auth::guard('adviser')->user()->prefect_fname . ' ' . Auth::guard('adviser')->user()->prefect_lname }}
                                    </h4>
                                    <p class="profile-role">Adviser</p>
                                    <div class="status-badge active">
                                        <i class="fas fa-circle"></i>
                                        <span
                                            id="profile-status">{{ Auth::guard('adviser')->user()->status ?? 'Active' }}</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="info-grid">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="info-value" id="profile-email">
                                            {{ Auth::guard('adviser')->user()->prefect_email }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="info-value" id="profile-gender">
                                            {{ Auth::guard('adviser')->user()->prefect_sex ?? 'Not specified' }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="info-value" id="profile-contact">
                                            {{ Auth::guard('adviser')->user()->prefect_contactinfo ?? 'Not provided' }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="verification-step-1" class="verification-step">
                                    ...
                                    <div class="step-content">
                                        ...
                                        <div class="email-preview">
                                            <i class="fas fa-envelope"></i>
                                            <span
                                                id="verification-email">{{ Auth::guard('adviser')->user()->prefect_email }}</span>
                                        </div>
    ...
    <main class="main-content" id="mainContent">
        <header class="main-header">
            ...
            <div class="user-info" onclick="toggleProfileDropdown()">
                ...
                <span
                    id="header-user-name">{{ Auth::guard('adviser')->user()->prefect_fname . ' ' . Auth::guard('adviser')->user()->prefect_lname }}</span>
    ...
    <script>
        ...
        function updateProfileImage(imageUrl) {
            ...
            const cachedImageUrl = `${imageUrl}${imageUrl.includes('?') ? '&' : '?'}t=${timestamp}`;
            ...
            if (headerProfileImage) {
                headerProfileImage.src = cachedImageUrl;
        ...
        async function uploadProfileImage(file) {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    if (!imageUrl && data.profile_image) {
                        imageUrl = '/storage/' + data.profile_image;
                    }
        ...
        async function removeProfileImage() {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    if (profileImage) profileImage.src = '/images/user.jpg';
