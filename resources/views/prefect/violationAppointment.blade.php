...
<div class="modal" id="bulkUpdateStatusModal">
    <div class="modal-content large-modal">
        ...
        <div class="edit-modal-body">
            <form id="bulkUpdateStatusForm" method="POST" action="{{ route('prefect.appointments.bulkUpdateStatus') }}">
                @csrf
        ...
        <div class="modal" id="updateStatusModal">
            <div class="modal-content">
                ...
                <!-- Body -->
                <div class="edit-modal-body">
                    <form id="updateStatusForm" method="POST" action="{{ route('prefect.appointments.updateStatus') }}">
                        @csrf
                        @method('PUT')
