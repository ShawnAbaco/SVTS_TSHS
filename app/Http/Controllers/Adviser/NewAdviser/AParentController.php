...
class AParentController extends Controller
{
    ...
    public function parentlists()
    {
        ...
        return view('adviser.NewAdviser.parentlists', array_merge(
    ...
    public function parentStore(Request $request)
    {
        ...
        try {
            ...
            if ($insertedCount > 0) {
                return redirect()->route('adviser.parent.lists')->with('success', $insertedCount . ' parent(s) added successfully!');
            } else {
    ...
    public function createParent()
    {
        ...
        return view('adviser.NewAdviser.create-parent', $notificationData);
    }
    ...
    public function update(Request $request)
{
    ...
    public function destroyParent($id)
    {
        try {
            ...
            return redirect()->route('adviser.parent.lists')->with('success', 'Parent moved to archive successfully.');
        } catch (\Exception $e) {
